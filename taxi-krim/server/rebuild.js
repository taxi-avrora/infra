...
process.env.NO_AUTOMAKE || watch([
    path.join(rootDir, 'templates', '*.templates', '**'),
    path.join(rootDir, 'blocks', '*.blocks', '**'),
    path.join(rootDir, 'blocks', 'design', '*.blocks', '**'),
    path.join(rootDir, 'pages', '**', '*.pages', '**'),
    path.join(rootDir, 'design', 'theme', '**'),
    path.join(rootDir, 'design', 'patterns', '**'),
    path.join(rootDir, 'design', 'typo', '**'),
    path.join(rootDir, 'design', 'layouts', '**'),
