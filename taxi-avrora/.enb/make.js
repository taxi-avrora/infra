        ...
        config.nodes(
            ...
            function (nodeConfig) {
                nodeConfig.addTechs([
                    ...
                    [
                        techs.borschik,
                        { source: "?.js", target: "?.min.js", minify: isProd },
                    ],
                    [
                        techs.borschik,
                        {
...
function getSourceLevels(platform) {
    ...
    platformNames.forEach(function (name) {
        ...
        levels.push({
            path: path.join("blocks", "design", name + ".blocks"),
            check: true,
        });
    });
    ...
    // Зависимости
    levels.push({
        path: path.join("node_modules", "bem-history", "common.blocks"),
        check: false,
    });
    levels.push({
        path: path.join("node_modules", "bem-stat-counters", "common.blocks"),
        check: false,
    });
    levels.push({
        path: path.join("node_modules", "vscroll", "common.blocks"),
        check: false,
    });
    ...
    platformNames.forEach(function (name) {
        levels.push({
            path: path.join("templates", name + ".templates"),
            check: true,
        });
    });
    ...
    platformNames.forEach(function (name) {
        levels.push({
            path: path.join("blocks", name + ".blocks"),
            check: true,
        });
